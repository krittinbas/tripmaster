...
class _MapCreatePageState extends State<MapCreatePage> {
  ...
  void getCurrentLocation() async {
    ...
    location.getLocation().then((value) {
      if (mounted) {
        print('Current Location: $value'); // Debugging line
      }
      setState(() {
  ...
  Future<void> _fetchAutocomplete(String query) async {
    ...
    final url = Uri.parse(
        'https://maps.googleapis.com/maps/api/place/autocomplete/json?input=$query&key=$apiKey&components=country:th');
  ...
  Future<void> _fetchNearbyPlaces(LatLng latLng) async {
    ...
    final nearbySearchUrl = Uri.parse(
      'https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=${latLng.latitude},${latLng.longitude}&radius=100&key=$apiKey&components=country:th',
    );
  ...
  void _selectSuggestion(String placeId, String description) async {
    ...
    final url = Uri.parse(
        'https://maps.googleapis.com/maps/api/place/details/json?place_id=$placeId&key=$apiKey&components=country:th');
    final response = await http.get(url);
